...
L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token={accessToken}', {
    ...
    tileSize: 512,
    zoomOffset: -1,
    accessToken: 'pk.eyJ1IjoibWl0Y2hlbDY5IiwiYSI6ImNrcDZwcXZqcDAwNzQyd255bWxtMzg2ZnkifQ.sQALs0-zapSAldnNhs0s7A' //plak de token als string hier 
}).addTo(mymap);
...
var myIcon = L.icon({
    iconUrl: '../../challenge-bnb/starterscode/images/roc.jpg',
    iconSize: [24, 24],
});
